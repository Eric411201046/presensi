...
//Route Yang Bisa di AKses Oleh supervisor dan supervisor vendor
Route::group(['middleware' => ['role:supervisor|supervisor vendor,user']], function () {
    Route::get('/proseslogoutadmin', [AuthController::class, 'proseslogoutadmin']);
    Route::get('/supervisor/dashboardadmin', [DashboardController::class, 'dashboardadmin']);
...
//ROute yang Hanya bisa di akses oleh supervisor
...
Route::get('/createrolepermission', function () {
    ...
    try {
        Role::create(['name' => 'supervisor vendor']);
