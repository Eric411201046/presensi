...
<head>
    ...
    <title>HadirKu-Supervisor Login</title>
    <!-- CSS files -->
    <link rel="icon" type="image/png" href="{{ asset('pegadaian.ico') }}" sizes="32x32">
        ...
        <div class="container container-normal py-4">
            <div class="row align-items-center g-4">
                <div class="col-lg">
                    <div class="container-tight">
                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <h1 class="h1 text-center mb-4">HadirKu</h1>
                                <h2 class="h2 text-center mb-4">Login Supervisor</h2>
                                ...
                                <form action="/prosesloginadmin" method="post" autocomplete="off" novalidate>
                                    ...
                                    <div class="form-footer">
                                        ...
                                        <label class="form-label">
                                                <a>Lupa Password ? Silahkan hubungi administrator</a>
                                        </label>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="col-lg d-none d-lg-block">
                    <img src="{{ asset('tabler/static/illustrations/logo.png') }}" height="150" class="d-block mx-auto" alt="">
                </div>
            </div>
        </div>
    </div>
