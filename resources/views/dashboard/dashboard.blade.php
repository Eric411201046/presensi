...
@section('content')
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div class="presencetab mt-2">
            <div class="tab-pane fade show active" id="pilled" role="tabsupervisor">
            ...
            <div class="tab-content mt-2" style="margin-bottom:100px;">
                <div class="tab-pane fade show active" id="home" role="tabsupervisor">
                    <!--
    ...
    @endforeach
                ...
                <div class="tab-pane fade" id="profile" role="tabsupervisor">
                    <ul class="listview image-listview">
